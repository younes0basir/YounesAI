              ...
              <AnimatePresence>
                {isActive && (
                  ...
                  >
                    ...
                    <span className="cc-step-beam-phase" style={{ color: step.color }}>
                      active
                    </span>
                  </motion.div>
                )}
...
export function TimelineInspector({ stepId, onClose }) {
  ...
  return (
    ...
    >
      <button
        type="button"
        className="cc-tl-inspector-close"
        onClick={onClose}
      ...
      <div className="cc-tl-inspector-head" style={{ background: `${step.color}14` }}>
        <span className="cc-tl-inspector-icon" style={{ background: step.color }}>
          <Icon size={16} />
        </span>
        <div>
          <h4>{detail.title}</h4>
      ...
      <div className="cc-tl-inspector-body">
        ...
        <div className="cc-tl-block">
          <span className="cc-tl-block-label">
        ...
        <div className="cc-tl-block">
          ...
          <div className="cc-tl-tools">
            {detail.tools.map((t) => (
              <span key={t} className="cc-tool-chip">
                {t}
              </span>
            ))}
          </div>
