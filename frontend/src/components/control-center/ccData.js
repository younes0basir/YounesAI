import {
  MessageSquare, Brain, Search, Database, Terminal, ShieldCheck, Send,
  Network, GitBranch, Activity, BarChart3, Plus, Wrench, HardDrive,
  Copy, Pause, Play, MemoryStick, ListOrdered, FileSearch,
} from 'lucide-react'

export const WORKSPACE_MODES = [
  { id: 'network', label: 'Network', icon: Network, hint: 'Living view of the whole crew' },
  { id: 'workflow', label: 'Workflow', icon: GitBranch, hint: 'How a request flows through stages' },
...
export const TIMELINE_STEPS = [
  ...
  { id: 'knowledge', label: 'Knowledge Agent', short: 'Knowledge', icon: Database, color: '#f59e0b' },
...
export const PALETTE_COMMANDS = [
  { id: 'create-agent', label: 'Create Agent', hint: 'Spawn a new specialist into the crew', icon: Plus },
  { id: 'create-subagent', label: 'Create Subagent', hint: 'Branch a focused worker from a node', icon: GitBranch },
  { id: 'assign-task', label: 'Assign Task', hint: 'Give the selected agent a live objective', icon: ListOrdered },
  ...
  { id: 'resume-agent', label: 'Resume Agent', hint: 'Wake the selected agent back up', icon: Play },
  { id: 'clone-agent', label: 'Clone Agent', hint: 'Duplicate the selected node', icon: Copy },
  { id: 'inspect-memory', label: 'Inspect Memory', hint: 'Open memory & conversation inspector', icon: MemoryStick },
